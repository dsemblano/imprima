	...
	class XforWC_Improved_Options_Settings {
		...
		public static function get_settings() {
			...
			$plugins['improved_options'] = array(
				...
				'name' => function_exists( 'XforWC' ) ? esc_html__( 'Product Options', 'improved-variable-product-attributes' ) : esc_html__( 'Improved Product Options for WooCommerce', 'improved-variable-product-attributes' ),
				'desc' => function_exists( 'XforWC' ) ? esc_html__( 'Improved Product Options for WooCommerce', 'improved-variable-product-attributes' ) . ' v' . XforWC_Improved_Options::$version : esc_html__( 'Settings page for Improved Product Options for WooCommerce!', 'improved-variable-product-attributes' ),
						...
						'settings' => array(
							'ivpa_attr' => array(
								...
								'ivpa_required' => array(
									...
									'type' => 'checkbox',
									'desc' => esc_html__( 'This option is required (Only works on simple products, variable product attributes are required always)', 'improved-variable-product-attributes' ),
									'id'   => 'ivpa_required',
									'default' => 'no'
								),
							),
