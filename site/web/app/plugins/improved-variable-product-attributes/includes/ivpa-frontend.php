					...
					<?php
						...
						switch ( $curr['style'] ) {
							...
							case 'ivpac_textarea' :
								...
								?>
									<span class="ivpa_term ivpa_custom ivpa_group_custom"><span class="ivpa-notconfirmed"><?php esc_html_e( 'Click to confirm input', 'improved-variable-product-attributes' ); ?></span><span class="ivpa-confirmed"><?php esc_html_e( 'Input confirmed', 'improved-variable-product-attributes' ); ?></span></span>
								<?php
								}
							...
							if ( self::$settings['wc_settings_ivpa_step_selection'] == 'yes' && $curr['style'] !== 'ivpac_checkbox' ) {
							?>
								<span class="ivpa_term ivpa_custom ivpa_group_custom"><span class="ivpa-notconfirmed"><?php esc_html_e( 'Click to confirm selection', 'improved-variable-product-attributes' ); ?></span><span class="ivpa-confirmed"><?php esc_html_e( 'Selection confirmed', 'improved-variable-product-attributes' ); ?></span></span>
							<?php
							}
